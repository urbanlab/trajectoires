            ...
            <div className="flex lg:flex-row flex-col bg-white p-8  border-l-3  border-(--green)  justify-between gap-10">
                <div className="flex items-center gap-5">
                    ...
                    <div className ="flex flex-col gap-3 ">
                        <p className="text-[1.5em] font-medium">{qty} entités ont été identifiées et sont prêtes à être intégrées</p>
                        <p className="text-[1.5em] italic">Vérifiez les informations et sauvegarder l’intégration. Si des erreurs sont présentes, vous pouvez annuler et déposer un nouveau gabarit</p>
                    </div>
                </div>
