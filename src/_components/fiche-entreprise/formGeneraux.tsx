    ...
    <div className="bg-(--light-grey) flex flex-col p-5">
      <Form layout="vertical" onFinish={onFinish} form={form}>
        ...
        <Form.Item
          label={'Siret'}
          name="Siret"
          rules={[{ required: true, message: 'Veuillez saisir le n° de Siret de l\'entreprise' }]}
        >
          <Input />
        </Form.Item>
        <Form.Item
          label={'Code APE'}
          name="Code_APE"
          rules={[{ required: true, message: 'Veuillez saisir le code APE de l\'entreprise' }]}
        >
          <Input />
        </Form.Item>
        <Form.Item
          ...
          rules={[{ required: true, message: 'Veuillez saisir le secteur d\'activité de l\'entreprise' }]}
        >
          <Input />
        </Form.Item>
          ...
          <div className="flex gap-5">
            <div className="flex-1">
              <Form.Item
                ...
                name="Numero_voie"
                rules={[{ required: true, message: 'Veuillez renseigner le numéro de voie' }]}
              >
                <Input />
              </Form.Item>
            ...
            <div className="flex-1">
              <Form.Item
                label={'Nom de voie'}
                name="Nom_voie"
                rules={[{ required: true, message: 'Veuillez renseigner le nom de la voie' }]}
              >
                <Input />
              </Form.Item>
            </div>
          ...
          <div className="flex gap-5">
            ...
            <div className="flex-1">
              <Form.Item
                label={'Ville'}
                name="Commune"
                rules={[{ required: true, message: 'Veuillez renseigner le nom de la commune' }]}
              >
                <Input />
              </Form.Item>
            </div>
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: 'Veuillez renseigner le nombre de salariés' }]}
        >
        ...
        <Form.Item
          ...
          name="Nb_Interim"
          rules={[{ required: true, message: 'Veuillez renseigner le nombre d\'interimaires et/ou sous-traitants' }]}
        >
          <InputNumber style={{width: '100%', fontSize:'20px'}}/>
        </Form.Item>
        <Form.Item
          ...
          rules={[{ required: true, message: 'Veuillez renseigner le nombre de jours travaillés' }]}
        >
          <InputNumber style={{width: '100%', fontSize:'20px'}}/>
        </Form.Item>
        <Form.Item
          ...
          rules={[{ required: true, message: 'Veuillez renseigner un rythme de travail' }]}>
