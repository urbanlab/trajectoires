    ...
    return (
        createPortal(
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 ">
                <div className="relative flex flex-col gap-6 bg-[#F7F7F7] p-8 shadow-2xl w-full max-w-[600px]   ">
                    ...
                    <span className='text-[2em] font-bold' style={{color: token.colorPrimary}}>La démarche</span>
                    <span className="text-[1.5em]">{Content.demarche}</span>
                    <span className='text-[2em] font-bold' style={{color: token.colorPrimary}}>Ressources</span>
