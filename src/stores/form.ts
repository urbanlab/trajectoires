...
const FIELDS_BY_CATEGORY = {
  ...
  vehicules: [
    'Nb_poids_lourds_critair0',
    'Nb_poids_lourds_critair1',
    'Nb_poids_lourds_critair2',
    'Nb_poids_lourds_critair3_',
    'Nb_voiture_fonction_critair0',
    'Nb_voiture_fonction_critair1',
    'Nb_voiture_fonction_critair2',
    'Nb_voiture_fonction_critair3_',
    'Nb_voiture_service_critair0',
    'Nb_voiture_service_critair1',
    'Nb_voiture_service_critair2',
    'Nb_voiture_service_critair3_',
    'Nb_velo_service',
    'Nb_velo_fonction'
  ],
  infra: [
    ...
    'Nb_Velo_securisees',
    'Nb_Velo_normales',
    'Places_velo_recharge',
    'Nb_Velo_recharge',
    'Nb_Douches',
    'Nb_vestiaires',
    'Nb_espaces_reparation'
  ],
  incitation: [
    'FMD',
    'Pourc_remb_transport',
    'Nb_pers_FMD',
    'Nb_abo_remb',
    'Montant_total_remb',
    'Outil_MER_covoit',
    'Deja_fait_enquete_mob'
  ]
}
